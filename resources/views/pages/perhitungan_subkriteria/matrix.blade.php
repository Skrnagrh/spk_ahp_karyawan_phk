<x-app-layout>
    ...
    <div class="container-fluid">
        @section('title')Matrix Subriteria @endsection
        <h4 class="mb-2 mt-4 text-capitalize">Matrix Perbandingan {{ $kriteria->nama_kriteria }}</h4>
        <hr>
...
{{-- <script>
    ...
    $('form').submit(function(event) {
        ...
        submitForm(); // Call the submitForm function to submit the form via AJAX
    });
    ...
    $('.matrix_select').on('change', function(e) {
        ...
        if (!selectedOption.is(':disabled')) {
            ...
            // Submit the form after changing the select option
            submitForm();
        }
    });
